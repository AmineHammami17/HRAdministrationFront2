...
export class TaskTrackingComponent implements OnInit{
  constructor(private projectService:ProjectService,private taskService:TaskService,private userService:UsersService,private holidayService : HolidaysService){}
  project:any;
  selectedDate: any;
  userId:any;
  tasks:any;
